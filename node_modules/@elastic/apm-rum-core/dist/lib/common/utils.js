...
exports.getNavigationTimingMarks = getNavigationTimingMarks;
exports.getPaintTimingMarks = getPaintTimingMarks;
...
exports.rng = _rngBrowser.default;
...
function generateRandomId(length) {
  var id = bytesToHex((0, _rngBrowser.default)());
...
function scheduleMicroTask(callback) {
  _es6Promise.Promise.resolve().then(callback);
}